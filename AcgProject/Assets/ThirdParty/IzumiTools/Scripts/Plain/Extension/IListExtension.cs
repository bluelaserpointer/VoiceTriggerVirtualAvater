...
public static class IListExtension
{
    ...
    public static List<T> Shuffle_InsideOut<T>(this IList<T> list)
    {
    ...
    public static T RemoveAndGetAt<T>(this IList<T> list, int index)
    {
        T element = list[index];
        list.RemoveAt(index);
        return element;
    ...
    public static T RemoveOne<T>(this IList<T> list, Predicate<T> match)
    {
